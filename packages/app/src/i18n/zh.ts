...
export const dict = {
  ...
  "provider.llamacpp.field.modelID.label": "模型 ID",
  "provider.llamacpp.field.modelID.placeholder": "my-local-model",
  "provider.llamacpp.field.name.label": "显示名称",
  "provider.llamacpp.field.name.placeholder": "我的本地模型",
  "provider.llamacpp.field.gguf.label": "GGUF 文件路径",
  "provider.llamacpp.field.gguf.placeholder": "C:/models/my-model.gguf",
  "provider.llamacpp.field.gguf.description": "本机上 GGUF 模型文件的绝对路径",
  "provider.llamacpp.field.gguf.browse": "选择 GGUF 模型文件",
  "provider.llamacpp.error.modelID.required": "模型 ID 为必填项",
  "provider.llamacpp.error.name.required": "显示名称为必填项",
  "provider.llamacpp.error.gguf.required": "GGUF 文件路径为必填项",
  "provider.llamacpp.field.advanced.title": "高级设置",
  "provider.llamacpp.field.contextSize.label": "上下文窗口大小",
  "provider.llamacpp.field.contextSize.description": "模型能处理的最大上下文长度（tokens），建议值：4096、8192、16384",
  "provider.llamacpp.field.gpuLayers.label": "GPU 层数量",
  "provider.llamacpp.field.gpuLayers.description": "卸载到 GPU 的层数，设为 0 则使用纯 CPU，设为 99 则全部使用 GPU",
  "provider.llamacpp.field.temperature.label": "温度",
  "provider.llamacpp.field.temperature.description": "控制输出随机性，值越高越随机，建议值：0.1-0.7",
  "provider.llamacpp.field.topP.label": "Top P ( Nucleus Sampling)",
  "provider.llamacpp.field.topP.description": "控制token选择的概率阈值，值越高可选的token越多，建议值：0.9-0.95",
  "provider.llamacpp.field.topK.label": "Top K",
  "provider.llamacpp.field.topK.description": "限制每次选择时考虑的最高概率token数量，建议值：20-50",
  "provider.llamacpp.field.repeatPenalty.label": "重复惩罚",
  "provider.llamacpp.field.repeatPenalty.description": "防止模型重复输出相同内容，建议值：1.0-1.1",
  "provider.llamacpp.field.flashAttention.label": "Flash Attention",
  "provider.llamacpp.field.flashAttention.description": "启用 Flash Attention 加速推理",

  "dialog.provider.llamacpp.note": "直接在本地运行 GGUF 模型",
