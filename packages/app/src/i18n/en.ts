export const dict = {
  ...
  "dialog.provider.llamacpp.note": "Run local GGUF models directly on your machine",

  "provider.llamacpp.title": "LlamaCpp",
  "provider.llamacpp.field.modelID.label": "Model ID",
  "provider.llamacpp.field.modelID.placeholder": "my-local-model",
  "provider.llamacpp.field.name.label": "Display name",
  "provider.llamacpp.field.name.placeholder": "My Local Model",
  "provider.llamacpp.field.gguf.label": "GGUF file path",
  "provider.llamacpp.field.gguf.placeholder": "C:/models/my-model.gguf",
  "provider.llamacpp.field.gguf.description": "Absolute path to the GGUF model file on your machine",
  "provider.llamacpp.field.gguf.browse": "Select GGUF model file",
  "provider.llamacpp.error.modelID.required": "Model ID is required",
  "provider.llamacpp.error.name.required": "Display name is required",
  "provider.llamacpp.error.gguf.required": "GGUF file path is required",
  "provider.llamacpp.field.advanced.title": "Advanced Settings",
  "provider.llamacpp.field.contextSize.label": "Context Window Size",
  "provider.llamacpp.field.contextSize.description": "Maximum context length the model can handle (tokens). Recommended: 4096, 8192, 16384",
  "provider.llamacpp.field.gpuLayers.label": "GPU Layers",
  "provider.llamacpp.field.gpuLayers.description": "Number of layers to offload to GPU. 0 = CPU only, 99 = all layers to GPU",
  "provider.llamacpp.field.temperature.label": "Temperature",
  "provider.llamacpp.field.temperature.description": "Controls output randomness. Higher values are more random. Recommended: 0.1-0.7",
  "provider.llamacpp.field.topP.label": "Top P (Nucleus Sampling)",
  "provider.llamacpp.field.topP.description": "Controls token selection probability threshold. Higher values allow more tokens. Recommended: 0.9-0.95",
  "provider.llamacpp.field.topK.label": "Top K",
  "provider.llamacpp.field.topK.description": "Limits the number of highest probability tokens considered. Recommended: 20-50",
  "provider.llamacpp.field.repeatPenalty.label": "Repeat Penalty",
  "provider.llamacpp.field.repeatPenalty.description": "Prevents model from repeating same content. Recommended: 1.0-1.1",
  "provider.llamacpp.field.flashAttention.label": "Flash Attention",
  "provider.llamacpp.field.flashAttention.description": "Enable Flash Attention for faster inference",
